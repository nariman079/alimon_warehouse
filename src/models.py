...
from sqlalchemy import Column, Float, ForeignKey, Integer, String, Numberic
...
class Product(Base):
    ...
    price: Mapped[float] = mapped_column(Numberic(10,2), nullable=False)
...
class WriteDownLine(Base):
    ...
    write_down_id: Mapped[int] = mapped_column(ForeignKey('write_down.id'))
...
class ReceiptLine(Base):
    ...
    price: Mapped[str] = mapped_column(Numberic(10,2))
    total_price: Mapped[float] = mapped_column(Numberic(10,2))
...
class AdjustmentLine(Base):
    ...
    adjustment_id: Mapped[int] = mapped_column(ForeignKey('adjustment.id'))
